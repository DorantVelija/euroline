...
const WhyUs = () => {
    return(
        <div className="flex max-xl:flex-col justify-center mx-auto container xl:w-4/5 px-4 xl:px-32 py-32 md:px-32 xl:space-x-3">
            ...
            <div className="xl:w-1/2 space-y-10 md:space-y-20 md:translate-y-20">
